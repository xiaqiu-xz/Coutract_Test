...
/**
 * Matchers an integer value (must be a number and have no decimal places). A random example value
 * will be generated.
 */
 ...
 * @param format Datetime format string. See [Java
...
/**
 * String value that must match the provided datetime format string. Example values will be
 * generated using the current system date and time.
 * @param format Datetime format string. See [Java
 * SimpleDateFormat](https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html)
 */
...
/**
 * String value that must match the provided date format string. Example values will be generated
 * using the current system date and time.
 * @param format Datetime format string. See [Java
 * SimpleDateFormat](https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html)
 */
...
/**
 * String value that must match the provided time format string. Example values will be generated
 * using the current system date and time.
 * @param format Datetime format string. See [Java
 * SimpleDateFormat](https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html)
 */
...
/**
 * String value that must match the regular expression. Random values will be generated for the
 * examples.
 */
...
/**
 * Array of values that must have at least one value and each item in the array must match the
 * provided template.
 */
...
/**
 * Match a decimal value (number with atleast one digit after the decimal point). Random values will
 * be generated for examples.
 */
 ...
 * @param pathFragments list of path fragments, can be regular expressions. Only the Equals and
 * Matching matchers will work.
 */
IMatcher::Ptr Url(const std::string& basePath, const std::vector<IMatcher::Ptr>& pathFragments);
/**
 * Matches a URL composed of a base path and a list of path fragments. The base URL from the mock
 * server will be used.
 * @param pathFragments list of path fragments, can be regular expressions. Only the Equals and
 * Matching matchers will work.
 */
...
/**
 * Matches the items in an array against a number of variants. Matching is successful if each
 * variant occurs once in the array. Variants may be objects containing matching rules.
 * @param min The minimum size of the array
 * @param max The maximum size of the array
 * @param examples number of examples to generate.
 */
