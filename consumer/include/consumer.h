...
public:
     ...
     */
    Interaction given(const char* provider_state,
...
public:
    ...
    /**
     * Sets the body for the request using the example file and content type. Note that this will
     * attempt to load the entire example file in memory. Use small files for your testing.
     */
    Interaction withBinaryFile(const std::string& content_type,
                               const std::filesystem::path& example_file) const;
    /**
     * Sets the body for the request as a MIME multipart body using the example file and content
     * type. Note that this will attempt to load the entire example file in memory. Use small files
     * for your testing.
     */
    Interaction withMultipartFileUpload(const std::string& part_name,
     ...
     */
    Interaction withResponseHeaders(
        const std::unordered_map<std::string, std::vector<std::string>>& headers) const;
    /**
    ...
    /**
     * Sets the body for the response using the example file and content type. Note that this will
     * attempt to load the entire example file in memory. Use small files for your testing.
     */
    Interaction withResponseBinaryFile(const std::string& content_type,
                                       const std::filesystem::path& example_file) const;
    /**
     * Sets the body for the response as a MIME multipart body using the example file and content
     * type. Note that this will attempt to load the entire example file in memory. Use small files
     * for your testing.
     */
    Interaction withResponseMultipartFileUpload(const std::string& part_name,
                                                const std::string& content_type,
                                                const std::filesystem::path& example_file) const;
